...
<!-- 
  Made with love by Mas Imam!
  
 
     Instagram: @Telor_dadar
     TikTok: @gemati_
     Email: imamsetiawan105@gmail.com
...
<body>
   ...
   <div id="bodyblur">
     <!-- Wallpaper --><img src="https://i.ibb.co.com/20dVrqRs/GUm-LTnl-GXua-NYBv-Dm-Tto-GJmcw-PC.webp" id="wallpaper"/><div id="beneranblur"></div>
   </div>
   ...
   <div id='Content'>
     ...
     <div><blockquote id='bq' data-text='㋡'>
       <p id="kalimat">Mas Punya Sesuatu buat sayang❤️</p>
       ...
       <p id="pesan2">Sebentar...</p>
       <!-- Pesan -->
       <p id="pesan3">Ciee.. Ada yang Ultah Nih 🤣❤️</p>
       <p id="pesan4">Happy Birthday, </p>
       <p id="pesan5" class="gaya2">Nambah tua aja ya, hehe</p>
       <p id="pesan6" class="gaya2">Moga panjang umur biar tiap tahun bisa traktirin mas wkwk 😆❤️</p>
       <p id="pesan7" class="gaya2">Sehat selalu ya!</p>

       <p id="pesan8" class="gaya2">Canda wkwwk :v</p>
       <p id="pesan9" class="gaya2">Oh iya, semoga di hari spesialmu ini kamu dapat menjadi pribadi yang lebih baik dan cepet dapet jodoh❤️</p>
     ...
     <!-- Pesan Tambahan -->
     <p id="katatambahan" class="sembunyi">Gajadi deh soalnya  belum ketemu 😜</p>
